...
const Form: React.FC = () => {
  ...
  const { value: enteredPhone, isValid: phoneIsValid, valueChangedHandler: phoneChangeHandler } = useInput(isPhoneNumber);
  const { value: enteredAddress, isValid: addressIsValid, valueChangedHandler: addressChangeHandler } = useInput(isNotEmpty);
  ...
  const { value: enteredCountry, isValid: countryIsValid, valueChangedHandler: countryChangeHandler } = useInput(isNotEmpty);
  const { value: enteredMoneyNumber, isValid: moneyNumberIsValid, valueChangedHandler: moneyNumberChangeHandler } = useInput(hasNineDigit);
  const { value: enteredMoneyPin, isValid: moneyPinIsValid, valueChangedHandler: moneyPinChangeHandler } = useInput(hasFourDigit);
  ...
  const addressClasses = !addressIsValid && formIsChecked ? "form__item form__item--width invalid" : "form__item form__item--width";
    ...
    <form className="form">
      ...
      <div className="form__items-box">
        <div className={nameClasses}>
          ...
          <input className="form__input" id="name" type="text" placeholder="Alexei Ward" value={enteredName} onChange={nameChangeHandler} />
        </div>
        ...
        <div className={phoneClasses}>
          ...
          {!phoneIsValid && formIsChecked && <span className="form__item-error-msg">Enter valid phone number</span>}
          <input
            className="form__input"
            id="phone"
            type="text"
      ...
      <div className="form__items-box">
        <div className={zipClasses}>
          ...
          <input className="form__input" id="zip" type="text" placeholder="10001" value={enteredZip} onChange={zipChangeHandler} />
        </div>
        <div className={cityClasses}>
          ...
          <input className="form__input" id="city" type="text" placeholder="New York" value={enteredCity} onChange={cityChangeHandler} />
        </div>
        <div className={countryClasses}>
          <label className="form__label" htmlFor="country">
            Country
          </label>
          {!countryIsValid && formIsChecked && <span className="form__item-error-msg">Enter valid country</span>}
          <input
            className="form__input"
            id="country"
            type="text"
        ...
        {eMoneyIsChecked && (
          <>
            <div className={moneyNumberClasses}>
              ...
              {!moneyNumberIsValid && formIsChecked && <span className="form__item-error-msg">Enter valid money number</span>}
              <input
                className="form__input"
                id="e-money-number"
                type="text"
            ...
            <div className={moneyPinClasses}>
              ...
              {!moneyPinIsValid && formIsChecked && <span className="form__item-error-msg">Enter valid money PIN</span>}
              <input
                className="form__input"
                id="e-money-pin"
                type="text"
      ...
      {!eMoneyIsChecked && (
        <div className="from__cash-wrapper">
          ...
          <p className="form__cash-text">
            The ‘Cash on Delivery’ option enables you to pay in cash when our delivery courier arrives at your residence. Just make sure
